...
def ensemble_models_voting(rf_preds, nb_preds, vader_preds):
    '''
...
def ensemble_models_probas(rf_probas, nb_probas, vader_probas, weights=[1, 1, 1]):
    '''
...
if __name__ == '__main__':
    ...
    y_preds_probas = ensemble_models_probas(
                                rf_fmt_probas,
                                nb_fmt_probas,
                                y_probas_vader,
                                weights=[1, 0.8, 0.5]
    ...
    # FINAL MODEL
    y_preds_voting = ensemble_models_voting(y_preds_rf, y_preds_nb, y_preds_vader)
